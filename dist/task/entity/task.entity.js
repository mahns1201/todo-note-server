...
const sprint_entity_1 = require("../../sprint/entity/sprint.entity");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => sprint_entity_1.SprintEntity, (sprint) => sprint.id, { nullable: true }),
...
], TaskEntity.prototype, "isIssue", void 0);
